...
const predefinedQuestions = [
  "Bagaimana saya bisa mengurangi sisa makanan di rumah?",
  "Barang apa saja yang bisa didaur ulang dan bagaimana caranya?",
  "Bagaimana cara memulai komposting?",
  "Apa cara terbaik untuk mengurangi limbah plastik?",
  "Bagaimana cara membuang limbah elektronik dengan benar?",
];
            ...
            <div className="overflow-y-auto flex-1 p-4 space-y-4 bg-gray-50">
              {messages.length === 0 && (
                <div className="space-y-4">
                  <p className="text-sm text-center text-gray-600">Coba tanyakan tentang:</p>
                ...
                {selectedImage && (
                  ...
                  >
                    ...
                    <span className="text-sm text-green-700">
                      Gambar terpilih: {selectedImage.name}
                    </span>
                    <button
