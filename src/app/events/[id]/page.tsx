      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-6">
          ...
          <div className="p-8">
            ...
            {/* Contact Person */}
            {(ev.contactPersonName || ev.contactPersonPhone) && (
              <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl border border-blue-200 mt-4">
                ...
                <div>
                  ...
                  {ev.contactPersonName && (
                    <p className="font-semibold text-gray-900">{ev.contactPersonName}</p>
                  )}
                  ...
                  {ev.contactPersonEmail && (
                    <a href={`mailto:${ev.contactPersonEmail}`} className="text-sm text-blue-600 hover:underline">
                      {ev.contactPersonEmail}
                    </a>
                  )}
                </div>
