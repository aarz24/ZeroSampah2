          ...
          {events.map((ev) => {
            ...
            return (
              <Link 
                key={ev.event.id} 
                href={`/events/${ev.event.id}`} 
                className="group block bg-white rounded-2xl border-2 border-gray-200 hover:border-green-400 p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-3 mb-4 p-4 bg-gray-50/80 backdrop-blur-sm rounded-xl">
                    ...
                    {hasLocation && (
                      <button
                        ...
                        className="flex items-center gap-2 text-sm text-blue-600 hover:text-blue-700 font-semibold group/link cursor-pointer w-full"
                      >
                        <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                        </svg>
                        <span className="truncate group-hover/link:underline">📍 On Map</span>
                      </button>
                    )}
                    <div className="flex items-center gap-3 text-sm text-gray-700">
