            ...
            <div className="relative p-4 sm:p-6 md:p-8">
              ...
              <div className="space-y-4 sm:space-y-5">
                ...
                >
                  ...
                  <div className="flex-1 sm:ml-5">
                    <p className="font-bold text-sm sm:text-base text-gray-800">Jejak Karbon Ditekan</p>
                    <p className="text-xs sm:text-sm text-gray-500">Pengurangan emisi CO₂</p>
                  </div>
                  <div className="text-left sm:text-right">
        ...
        >
          ...
          <AnimatePresence>
            {expandedItem && (
              ...
              >
                <div className="relative bg-gradient-to-br from-white via-white to-green-50/30 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.1)] overflow-hidden">
                  {/* Decorative background elements */}
                  <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-green-100/50 to-transparent rounded-full blur-3xl" />
                  <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-blue-100/50 to-transparent rounded-full blur-3xl" />
                  ...
                  <div className="relative p-8 md:p-10">
                    ...
                    <div className="flex justify-between items-start mb-8">
                      ...
                      >
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="px-4 py-1.5 bg-green-100 text-green-600 text-sm font-bold rounded-full">
                            Panduan Lengkap
                          </span>
                        </div>
                        <h3 className="text-3xl md:text-4xl font-extrabold bg-gradient-to-r from-green-600 via-emerald-500 to-teal-500 bg-clip-text text-transparent">
                      ...
                      <motion.button
                        ...
                        className="p-3 bg-gradient-to-br from-gray-100 to-gray-200 hover:from-red-100 hover:to-red-200 rounded-2xl transition-all duration-300 shadow-md hover:shadow-lg group"
                      >
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-10">
                      ...
                      >
                        <div className="absolute -inset-1 bg-gradient-to-r from-green-400 to-emerald-400 rounded-3xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500" />
                        <div className="relative bg-gradient-to-br from-green-50 via-green-50 to-emerald-100/50 rounded-2xl p-6 border border-green-100 shadow-lg hover:shadow-xl transition-all duration-300">
                      ...
                      <motion.div
                        ...
                        className="relative group"
                      >
                        <div className="absolute -inset-1 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-3xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500" />
                        <div className="relative bg-gradient-to-br from-blue-50 via-blue-50 to-cyan-100/50 rounded-2xl p-6 border border-blue-100 shadow-lg hover:shadow-xl transition-all duration-300">
                          <div className="flex items-center gap-3 mb-4">
                            <div className="p-2.5 rounded-xl bg-gradient-to-br from-blue-400 to-cyan-500 shadow-md">
                              <Sparkles className="w-5 h-5 text-white" />
                            </div>
                            <h4 className="text-xl font-bold bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">
                              Tips Berguna
                            </h4>
                          </div>
                          <ul className="space-y-3">
                            {recyclingItems[expandedItem as keyof typeof recyclingItems].tips.map((tip, i) => (
                              ...
                              >
                                <div className="flex-shrink-0 p-1 rounded-lg bg-gradient-to-br from-blue-400 to-cyan-400 shadow-sm group-hover/item:scale-110 transition-transform">
                    ...
                    >
                      <div className="flex items-center gap-3 mb-6">
                        <div className="p-2.5 rounded-xl bg-gradient-to-br from-green-400 to-teal-500 shadow-md">
                          <FileText className="w-5 h-5 text-white" />
                        </div>
                        <h4 className="text-2xl font-bold bg-gradient-to-r from-green-600 via-emerald-500 to-teal-500 bg-clip-text text-transparent">
                            ...
                            <div className="p-5">
                              <div className="flex gap-4">
                                ...
                                <motion.div
                                  ...
                                  transition={{ duration: 0.5 }}
                                  className={`flex-shrink-0 w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-lg shadow-lg transition-all duration-500 ${
                                    currentStep === i
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  {/* Image with overlay */}
                                  <div className={`relative w-full h-36 rounded-xl overflow-hidden transition-all duration-500 ${
                                    currentStep === i 
                                      ? 'ring-3 ring-green-400 shadow-lg' 
                                    ...
                                    {currentStep === i && (
                                      <motion.div
                                        ...
                                        animate={{ opacity: 1, scale: 1 }}
                                        className="absolute top-2 right-2 px-3 py-1 bg-green-500 text-white text-xs font-bold rounded-full shadow-lg flex items-center gap-1"
                                      >
                                        <motion.div
                                          animate={{ scale: [1, 1.3, 1] }}
