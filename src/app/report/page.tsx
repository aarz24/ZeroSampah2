  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-white to-emerald-50">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-20 left-10 w-48 sm:w-72 h-48 sm:h-72 bg-gradient-to-br from-green-200/30 to-emerald-300/20 rounded-full blur-3xl" />
        <div className="absolute bottom-40 right-20 w-64 sm:w-96 h-64 sm:h-96 bg-gradient-to-br from-lime-200/20 to-green-200/30 rounded-full blur-3xl" />
      </div>

      <div className="relative px-3 sm:px-4 py-8 sm:py-12 mx-auto max-w-5xl md:px-6 lg:px-8">
        {/* Header Section */}
        <motion.div 
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="relative overflow-hidden p-5 sm:p-8 md:p-10 mb-8 sm:mb-12 text-white bg-gradient-to-r from-green-600 via-emerald-500 to-teal-500 rounded-2xl sm:rounded-3xl shadow-2xl shadow-green-500/25"
        >
          {/* Decorative background elements */}
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div className="absolute -top-20 -right-20 w-48 sm:w-80 h-48 sm:h-80 bg-white/10 rounded-full blur-3xl" />
            <div className="absolute -bottom-20 -left-20 w-40 sm:w-64 h-40 sm:h-64 bg-emerald-400/20 rounded-full blur-3xl" />
          ...
          {[...Array(5)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute w-1.5 h-1.5 sm:w-2 sm:h-2 bg-white/30 rounded-full hidden sm:block"
              style={{
                top: `${15 + i * 18}%`,
                left: `${5 + i * 20}%`,
              }}
          ...
          <div className="relative flex flex-col md:flex-row items-center gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <motion.p 
                ...
                className="text-green-100 text-sm sm:text-base md:text-xl max-w-lg"
              >
                Bantu menjaga lingkungan dengan melaporkan sampah di sekitar Anda
              </motion.p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
          ...
          <div className="relative overflow-hidden p-5 sm:p-8 bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl border border-green-100">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="relative group">
                <div className="flex justify-center px-4 sm:px-8 py-10 sm:py-16 bg-gradient-to-br from-gray-50 to-green-50/50 rounded-xl sm:rounded-2xl border-2 border-dashed border-green-300/50 transition-all duration-300 group-hover:border-green-500 group-hover:bg-green-50/50 group-hover:shadow-lg">
                  <div className="space-y-3 sm:space-y-4 text-center">
                    <div className="relative">
                      ...
                      <FileImage className="relative mx-auto w-12 h-12 sm:w-16 sm:h-16 text-green-400 transition-all duration-300 group-hover:text-green-500 group-hover:scale-110" />
                    </div>
                    <div className="flex flex-col items-center">
                      <label
                        htmlFor="waste-image"
                        className="relative mb-2 sm:mb-3 px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-semibold text-white bg-gradient-to-r from-green-500 to-emerald-500 rounded-full cursor-pointer hover:from-green-600 hover:to-emerald-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                      >
                      ...
                      <p className="text-gray-500 text-sm">atau seret dan jatuhkan</p>
                      <p className="mt-2 sm:mt-3 text-xs sm:text-sm text-gray-400 flex flex-wrap justify-center items-center gap-1 sm:gap-2">
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-8 py-4 sm:py-5 text-base sm:text-lg font-semibold rounded-xl sm:rounded-2xl transition-all duration-300 ${
                  !file
          ...
          {verificationStatus === "success" && verificationResult && (
            <div className="relative overflow-hidden p-5 sm:p-8 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl sm:rounded-3xl shadow-xl border border-green-200">
              <div className="absolute top-0 right-0 w-24 sm:w-40 h-24 sm:h-40 bg-green-200/30 rounded-full blur-3xl" />
              <div className="relative flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0">
                  <div className="p-3 sm:p-4 bg-gradient-to-br from-green-400 to-emerald-500 rounded-xl sm:rounded-2xl shadow-lg">
                    <CheckCircle className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                  </div>
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="mb-1 sm:mb-2 text-xl sm:text-2xl font-bold text-gray-900">
                    Analisis Selesai
                  </h3>
                  <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">Sampah berhasil diidentifikasi oleh AI</p>
                  <div className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2">
                    <div className="p-4 sm:p-5 bg-white rounded-xl sm:rounded-2xl border border-green-100 shadow-md">
                      <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                        <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-green-500 rounded-full" />
                        <p className="text-xs sm:text-sm font-medium text-gray-500">Jenis Sampah</p>
                      </div>
                    ...
                    <div className="p-4 sm:p-5 bg-white rounded-xl sm:rounded-2xl border border-green-100 shadow-md">
                      <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                        ...
                        <p className="text-xs sm:text-sm font-medium text-gray-500">Perkiraan Jumlah</p>
                      </div>
                      <p className="text-lg sm:text-xl font-bold text-gray-900">
          ...
          <div className="relative overflow-hidden p-5 sm:p-8 bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl border border-green-100">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-2 sm:space-y-3">
                <label htmlFor="location" className="block text-xs sm:text-sm font-semibold text-gray-700">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 text-sm sm:text-base rounded-xl sm:rounded-2xl border-2 border-gray-200 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-green-500/20 focus:border-green-500 placeholder:text-gray-400"
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base font-semibold text-green-700 bg-gradient-to-r from-green-100 to-emerald-100 rounded-xl sm:rounded-2xl transition-all duration-300 cursor-pointer hover:from-green-200 hover:to-emerald-200 hover:shadow-lg"
                  >
              ...
              <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2">
                <div className="space-y-2 sm:space-y-3">
                  <label htmlFor="type" className="block text-xs sm:text-sm font-semibold text-gray-700">
                    Jenis Sampah
                  </label>
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      required
                      className="w-full px-4 py-3 sm:py-4 text-sm sm:text-base text-gray-700 bg-gray-50 rounded-xl sm:rounded-2xl border-2 border-gray-200 focus:outline-none focus:border-green-500 focus:ring-4 focus:ring-green-500/20"
                      placeholder="Jenis sampah terverifikasi"
                      readOnly
                    />
                    {newReport.type && (
                      <CheckCircle className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-green-500" />
                    )}
                  </div>
                </div>

                <div className="space-y-2 sm:space-y-3">
                  <label htmlFor="amount" className="block text-xs sm:text-sm font-semibold text-gray-700">
                    Perkiraan Jumlah
                  </label>
                  <div className="relative">
                    <input
