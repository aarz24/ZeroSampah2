...
-- 11. Event Attendance table (verified check-ins)
...
-- 13. Triggers to keep updated_at fresh
DO $$
BEGIN
  IF NOT EXISTS (
...
-- 14. Sample seed data (optional) - comment out if not needed
...
-- 15. Basic RLS policies (enable if you want Supabase Row Level Security)
